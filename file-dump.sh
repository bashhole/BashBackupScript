...
# (1) set up all the server connect variables
...
# use this command for a archive server on localhost. add other options if need be.
cd /backup/
rsync -avzh /home/ ${FILE}
# (4) gzip the file archive dump file
